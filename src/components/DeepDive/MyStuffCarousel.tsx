        ...
        <div className="relative">
          ...
          <AnimatePresence mode="wait" custom={direction} initial={false}>
            <motion.div
              ...
              tabIndex={0}
              className="panel panel-hud p-5 md:p-8 flex flex-col lg:h-[480px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--clr-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--clr-bg)]"
            >
